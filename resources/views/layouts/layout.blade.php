    ...
    <nav class="navbar navbar-default">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a href="/" class="navbar-brand"><img alt="" longdesc="image" src="/img/logo.png"></a>
            </div>
                    ...
                    @if (!Auth::guest())
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img alt="" longdesc="image" src="/img/flags/{{ \App::getLocale() }}_logo.png">
                            </a>
                            <ul class="dropdown-menu">
                                @foreach (\Config::get('languages') as $lang => $language)
                                    @if ($lang != App::getLocale())
                                        <li>
                                            <a href="/lang/{{ $lang }}"><img alt="" longdesc="image"
